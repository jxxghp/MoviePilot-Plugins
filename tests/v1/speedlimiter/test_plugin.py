...
def test_polling_triggers_fixed_limit_without_webhook_or_bitrate(monkeypatch):
    ...
    monkeypatch.setattr(speedlimiter_module, "settings", SimpleNamespace(MEDIASERVER="jellyfin"))
    monkeypatch.setattr(speedlimiter_module, "Jellyfin", JellyfinApi)
    monkeypatch.setattr(
        plugin,
