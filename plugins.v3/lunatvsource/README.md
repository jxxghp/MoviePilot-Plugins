...
接入 MoonTV/LunaTV 的 Apple CMS 资源站，串行下载到 MoviePilot 的系统目录或插件指定目录。支持 MoviePilot V3 探索源、订阅刷新、TMDB 关联、多季边界保护、`.strm`、整理历史和媒体库刷新。
...
- 搜索结果会尝试关联 TMDB；只有线路或 TMDB 能确定季集边界时才拆分多季合集，无法确认会提示人工选择。
