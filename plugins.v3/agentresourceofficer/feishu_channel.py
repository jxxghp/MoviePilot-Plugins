    ...
    def _query_media_detail(self, keyword: str, media_type: str = "", year: str = "") -> Dict[str, Any]:
        ...
        try:
            ...
            item = {
                ...
                "media_source": str(getattr(mediainfo, "media_source", "") or ""),
                "media_id": str(getattr(mediainfo, "media_id", "") or ""),
                "season": season,
            ...
            lines = [
                ...
                f"类型：{item.get('type') or '-'} | 来源：{item.get('media_source') or '-'} | ID：{item.get('media_id') or '-'}",
            ]
        ...
        try:
            ...
            for sub in subscribes:
                ...
                items.append({
                    ...
                    "media_id": str(getattr(sub, "media_id", "") or ""),
        ...
        try:
            ...
            for index, record in enumerate(selected_records, start=(page_num - 1) * page_size + 1):
                ...
                item = {
                    ...
                    "media_id": str(getattr(record, "media_id", "") or ""),
