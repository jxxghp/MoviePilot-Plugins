...
const _hoisted_8 = {
  key: 0,
  class: "d-flex align-center px-3 pt-2 hrb-stages"
};
const _hoisted_9 = {
  key: 0,
  class: "hrb-empty"
...
const _hoisted_13 = { class: "hrb-item-meta" };
...
function stageColor(stage) {
  return STAGE_COLORS[stage] || 'grey'
}
const stageList = computed(() => [...new Set(records.value.map(r => r.stage).filter(Boolean))]);
function stageCount(s) {
  return records.value.filter(r => r.stage === s).length
}
const filteredRecords = computed(() =>
  activeStage.value ? records.value.filter(r => r.stage === activeStage.value) : records.value
);
...
return (_ctx, _cache) => {
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
    _createElementVNode("div", _hoisted_2, [
      _createElementVNode("div", _hoisted_3, [
        ...
        _createElementVNode("div", null, [
          _createElementVNode("div", _hoisted_4, [
            _cache[3] || (_cache[3] = _createElementVNode("h2", { class: "ma-0" }, "H&R Blocker", -1)),
      ...
      _cache[4] || (_cache[4] = _createElementVNode("div", { class: "hrb-header-actions" }, null, -1))
    ]),
          ...
          default: _withCtx(() => [
            _createVNode(_component_v_card_title, { class: "d-flex align-center py-2 px-4" }, {
              default: _withCtx(() => [
                ...
                _cache[7] || (_cache[7] = _createElementVNode("span", { class: "text-subtitle-1" }, "H&R 屏蔽记录", -1)),
                _createVNode(_component_v_chip, {
                  class: "ml-2",
                  size: "x-small",
                  color: "error",
            ...
            (records.value.length > 0)
              ? (_openBlock(), _createElementBlock("div", _hoisted_8, [
                  _createVNode(_component_v_chip, {
                    size: "small",
                    variant: activeStage.value === '' ? 'flat' : 'tonal',
                    color: "primary",
                    onClick: _cache[1] || (_cache[1] = $event => (activeStage.value = ''))
                  }, {
                    default: _withCtx(() => [
                      _createTextVNode("全部 " + _toDisplayString(records.value.length), 1)
                    ]),
                    _: 1
                  }, 8, ["variant"]),
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(stageList.value, (s) => {
                    return (_openBlock(), _createBlock(_component_v_chip, {
                      key: s,
                      size: "small",
                      color: stageColor(s),
                      variant: activeStage.value === s ? 'flat' : 'tonal',
                      onClick: $event => (activeStage.value = activeStage.value === s ? '' : s)
                    }, {
                      default: _withCtx(() => [
                        _createTextVNode(_toDisplayString(s) + " " + _toDisplayString(stageCount(s)), 1)
                      ]),
                      _: 2
              ...
              default: _withCtx(() => [
                (records.value.length === 0 && !loading.value)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_9, [
                      ...
                      _cache[8] || (_cache[8] = _createElementVNode("div", { class: "text-medium-emphasis text-body-2" }, "暂无屏蔽记录", -1)),
                      _cache[9] || (_cache[9] = _createElementVNode("div", { class: "text-caption text-disabled mt-1" }, "被拦截的 H&R 种子会显示在这里", -1))
                    ]))
                  : (filteredRecords.value.length === 0)
                    ? (_openBlock(), _createElementBlock("div", _hoisted_10, [...(_cache[10] || (_cache[10] = [
                        _createElementVNode("div", { class: "text-medium-emphasis text-body-2" }, "该分类下暂无记录", -1)
                      ]))]))
                    : _createCommentVNode("", true),
                (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(filteredRecords.value, (rec, i) => {
                  return (_openBlock(), _createElementBlock("div", {
                    ...
                    _createElementVNode("div", _hoisted_11, [
                      ...
                      _createElementVNode("span", {
                        class: "hrb-title",
                        title: rec.title
                      }, _toDisplayString(rec.title), 9, _hoisted_12)
                    ]),
                    _createElementVNode("div", _hoisted_13, [
                      _createElementVNode("span", null, _toDisplayString(rec.time), 1),
                      (rec.site)
                        ? (_openBlock(), _createElementBlock("span", _hoisted_14, "站点：" + _toDisplayString(rec.site), 1))
                        : _createCommentVNode("", true),
                      _createElementVNode("span", null, _toDisplayString(rec.reason), 1),
                      (rec.source)
                        ? (_openBlock(), _createElementBlock("span", _hoisted_15, "来源：" + _toDisplayString(rec.source), 1))
                        : _createCommentVNode("", true)
                    ])
                  ]))
                }), 128))
...
const Page = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-4390de17"]]);
