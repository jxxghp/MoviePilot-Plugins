...
基于 [autosub](https://github.com/lightolly/MoviePilot-Plugins) 修改并适配 MoviePilot V3，感谢原作者
...
8. MoviePilot V3 的 Python 3.14 依赖支持 Linux x64/ARM64、Windows x64 和 macOS 14+ Apple Silicon；macOS Intel 暂不支持。
